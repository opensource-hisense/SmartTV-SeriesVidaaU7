...
export UTIL_LINUX_INSTALL_PATH      =   ${OSS_LIB_ROOT}/util-linux/${UTIL_LINUX_VER}
...
export UTIL_LINUX_SRC_PATH          = $(OSS_SRC_ROOT)/util-linux
...
export UTIL_LINUX_SRC_BUILD_PATH          = $(UTIL_LINUX_SRC_PATH)/${UTIL_LINUX_VER}
