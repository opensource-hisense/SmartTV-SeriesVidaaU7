...
#include <bits/unique_ptr.h>    //STDLIBC_INTEGER
namespace android {
...
constexpr const char* const kDownstreamManualInterfaces[] = {
  ...
  "mstar.MI.InjplayService",
  "mstar.MI.InjplayCallbkService",
  "mstar.MI.VocService",
  "mstar.MI.MmService",
  "mstar.MI.MmCallbkService",
  "mstar.MI.DrmService",
  "mstar.MI.CcService",
  "mstar.MI.PvrCallbkService",
  "mstar.MI.PvrService",
  "mstar.MI.SubtitleService",
  "mstar.MI.TtxService",
  "mediatek.GAMService",
  "mediatek.IIPCManagerService",
  "mediatek.IIPCManagerClient",
  "mediatek.IIPCManager",
  nullptr,
};
