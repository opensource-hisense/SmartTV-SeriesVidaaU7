...
#include <sepol/private.h>  //STDLIBC_INTEGER
#include <sepol/context.h>  //STDLIBC_INTEGER
#include <sepol/av_permissions.h>  //STDLIBC_INTEGER
#include <sepol/dso.h>  //STDLIBC_INTEGER
#include <sepol/mls.h>  //STDLIBC_INTEGER
