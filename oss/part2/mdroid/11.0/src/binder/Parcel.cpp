...
#define ULONG_MAX 0xffffffff //STDLIBC_INTEGER
#define SIZE_T_MAX ULONG_MAX  //STDLIBC_INTEGER
#define LOG_REFS(...)
...
//STDLIBC_INTEGER static_assert(sizeof(Parcel) == 60 || sizeof(Parcel) == 120);
