...
volatile bool BpBinder::sCountByUidEnabled = false;//STDLIBC_INTEGER
...
//void BpBinder::enableCountByUid() { sCountByUidEnabled.store(true); }//STDLIBC_INTEGER
void BpBinder::enableCountByUid() { sCountByUidEnabled = true; }//STDLIBC_INTEGER
//void BpBinder::disableCountByUid() { sCountByUidEnabled.store(false); }//STDLIBC_INTEGER
void BpBinder::disableCountByUid() { sCountByUidEnabled = false; }//STDLIBC_INTEGER
//void BpBinder::setCountByUidEnabled(bool enable) { sCountByUidEnabled = enable; }//STDLIBC_INTEGER
void BpBinder::setCountByUidEnabled(bool enable) { sCountByUidEnabled = enable; }//STDLIBC_INTEGER
