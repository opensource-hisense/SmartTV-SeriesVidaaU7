...
#undef HAVE_ANDROID_OS // STDLIBC_INTEGER
#include <assert.h>
#include <errno.h>
#include <memory.h>
#include <stdio.h>
...
#if defined(HAVE_PTHREADS)// STDLIBC_INTEGER
# include <pthread.h>
# include <sched.h>
# include <sys/resource.h>
#ifdef HAVE_ANDROID_OS// STDLIBC_INTEGER
# include <private/bionic_pthread.h>// STDLIBC_INTEGER
#endif// STDLIBC_INTEGER
#elif defined(HAVE_WIN32_THREADS)// STDLIBC_INTEGER
# include <windows.h>
# include <stdint.h>
# include <process.h>
...
#if defined(HAVE_PRCTL)// STDLIBC_INTEGER
#include <sys/prctl.h>
#endif
...
int Thread::_threadLoop(void* user)
{
    ...
    self->mTid = androidGetTid(); // STDLIBC_INTEGER
#endif
...
pid_t Thread::getTid() const
{
    ...
    if (mRunning) {
        ...
        //tid = pthread_gettid_np(pthread);// STDLIBC_INTEGER
		 tid = __pthread_gettid(pthread); // STDLIBC_INTEGER
    } else {
