...
EXPORT_SYMBOL INT32 c_rpc_init_mtk_bt_service_server(VOID)
{
    ...
    c_rpc_reg_mtk_bt_service_ble_scanner_op_hndlrs();
    c_rpc_reg_mtk_bt_service_ble_adv_op_hndlrs();
#endif
...
#if MTK_LEAUDIO_BMS
    c_rpc_reg_mtk_bt_service_bms_op_hndlrs();
    c_rpc_reg_mtk_bt_service_bass_op_hndlrs();
    c_rpc_reg_mtk_bt_service_bmr_op_hndlrs();
#endif
