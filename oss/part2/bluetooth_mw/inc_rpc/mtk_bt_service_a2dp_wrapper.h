 ...
 *  will enable/disable A2DP function.
 * INPUT:
 *      a2dp_handle  -- disable A2DP function
 * OUTPUT:
 *      N/A
 * RETURN:
 ...
 *
 */
extern INT32 a_mtkapi_a2dp_unregister_callback(mtkrpcapi_BtAppA2dpCbk a2dp_handle,
    VOID* pv_tag);
 ...
 *
 */
extern INT32 a_mtkapi_a2dp_src_set_channel_allocation_for_lrmode(CHAR *addr, INT32 channel);
 ...
 *
 */
extern INT32 a_mtkapi_a2dp_src_set_audiomode(INT32 audio_mode);
 ...
 *
 */
extern INT32 a_mtkapi_a2dp_src_enable(BOOL enable, BT_A2DP_SRC_INIT_CONFIG* p_src_init_config);
 ...
 *      N/A
 */
extern INT32 a_mtkapi_a2dp_src_active_sink(CHAR *addr);

/* FUNCTION NAME: a_mtkapi_a2dp_src_get_active_sink
 * PURPOSE:
 *      active a specified SINK then it can recv streaming data.
 * INPUT:
 *      addr    -- connect to this device
 ...
 *      N/A
 */
extern INT32 a_mtkapi_a2dp_src_get_active_sink(CHAR *addr);


/* FUNCTION NAME: a_mtkapi_a2dp_src_config_codec_info
 * PURPOSE:
 *      p_src_init_config  -- include max connected devices and configure the codecs settings preferences
 *
 * OUTPUT:
 *      N/A
 * RETURN:
 ...
 *
 */
extern INT32 a_mtkapi_a2dp_src_config_codec_info(CHAR *addr, BT_A2DP_SET_CODEC_CONFIG* p_src_codec_info);


/* FUNCTION NAME: a_mtkapi_a2dp_src_set_silence_device
 * PURPOSE:
 *      set a device to silence state.
 * INPUT:
 *      addr        -- The deivce's addr which will be set to silence state
 * OUTPUT:
 *      N/A
 * RETURN:
 *      BT_SUCCESS  -- connection is sent out successfully
 *      others      --set silence state fail.
 * NOTES:
 *
 */
extern INT32 a_mtkapi_a2dp_src_set_silence_device(CHAR *addr, BOOL enable);

/* FUNCTION NAME: a_mtkapi_a2dp_src_get_silence_device
 * PURPOSE:
 *      set a device to silence state.
 * INPUT:
 *      addr        -- The deivce's addr which will be get silence state
 * OUTPUT:
 *      N/A
 * RETURN:
 *      BT_SUCCESS  -- connection is sent out successfully
 ...
 *
 */
extern BOOL a_mtkapi_a2dp_src_is_in_silence_mode(CHAR *addr);
 ...
 */
extern INT32 a_mtkapi_a2dp_sink_set_link_num(INT32 local_sink_num);
 ...
 *      N/A
 */
extern INT32 a_mtkapi_a2dp_sink_active_src(CHAR *addr);

/* FUNCTION NAME: a_mtkapi_a2dp_sink_get_active_src
 * PURPOSE:
 *      active a specified src then sink can recv the src streaming data.
 * INPUT:
 *      addr    -- connect to this device
 * OUTPUT:
 *      N/A
 ...
 *      N/A
 */
extern INT32 a_mtkapi_a2dp_sink_get_active_src(CHAR *addr);
 ...
 */
extern INT32 a_mtkapi_a2dp_sink_set_delay_value(CHAR *addr, UINT16 value);
 ...
 *      N/A
 */
extern INT32 a_mtkapi_a2dp_sink_get_stack_delay(VOID);

extern INT32 a_mtkapi_a2dp_sink_lowpower_enable(BOOL enable);

extern INT32 c_rpc_reg_mtk_bt_service_a2dp_cb_hndlrs(VOID);

/* --------------------- ADD FOR bluedroid q migration------------------- */
