...
typedef void (*meshif_access_msg_handler) (uint16_t model_handle, meshif_access_message_rx_t *msg, void *arg);
...
typedef void (*meshif_health_client_evt_handler)(uint16_t model_handle, meshif_access_message_rx_t *msg, const meshif_health_client_evt_t *event);
