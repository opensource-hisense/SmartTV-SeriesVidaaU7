...
typedef enum
{
    GATT_ATTR_PERM_READ,               /* bit 0 */
    GATT_ATTR_PERM_READ_ENCRYPTED,     /* bit 1 */
    GATT_ATTR_PERM_READ_ENC_MITM,      /* bit 2 */
    GATT_ATTR_PERM_WRITE,              /* bit 4 */
    GATT_ATTR_PERM_WRITE_ENCRYPTED,    /* bit 5 */
    GATT_ATTR_PERM_WRITE_ENC_MITM,     /* bit 6 */
    GATT_ATTR_PERM_WRITE_SIGNED,       /* bit 7 */
    GATT_ATTR_PERM_WRITE_SIGNED_MITM,  /* bit 8 */
} GATT_ATTR_PERM;
...
typedef struct
{
    ...
    UINT8 properties;   /* bitwise of GATT_ATTR_PROP */
    UINT8 key_size;
