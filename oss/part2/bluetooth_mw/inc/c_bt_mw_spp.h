 ...
 *      None
 */
INT32 c_btm_spp_connect(BT_SPP_CONNECT_PARAM *param);
 ...
 *      None
 */
INT32 c_btm_spp_disconnect(BT_SPP_DISCONNECT_PARAM *param);
 ...
 *      None
 */
INT32 c_btm_spp_send_data(BT_SPP_SEND_DATA_PARAM *param);
 ...
 *      None
 */
INT32 c_btm_spp_start_server(BT_SPP_START_SVR_PARAM *param);
 ...
 */
INT32 c_btm_spp_stop_server(BT_SPP_STOP_SVR_PARAM *param);

INT32 c_btm_spp_get_connection_info(BT_SPP_CONNECTION_INFO_DB *spp_connection_info_db);
