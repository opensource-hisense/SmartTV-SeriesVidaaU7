...
typedef struct _IDirectFBDisplayLayer *EGLNativeDisplayType;
typedef struct _IDirectFBSurface *EGLNativePixmapType;
typedef struct _IDirectFBSurface *EGLNativeWindowType;
