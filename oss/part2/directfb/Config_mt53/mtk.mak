...
install::
	...
	install -c -m 644 $(MEDIATEK)/Tools/data/*.jpg $(DESTDIR)$(datadir)/
	install -c -m 644 $(MEDIATEK)/Tools/data/*.png $(DESTDIR)$(datadir)/
	install -c -m 644 $(MEDIATEK)/Tools/data/*.ttf $(DESTDIR)$(datadir)/
	install -c -m 644 $(MEDIATEK)/Tools/data/*.gif $(DESTDIR)$(datadir)/
...
ifeq "$(FT_VER)" "2.3.9"
	install -c -m 755 $(THIRDPARTY_LIB_ROOT)/freetype/$(FT_VER)/pre-install/lib/libfreetype.so.6.3.20 $(DESTDIR)$(libdir)/
endif
...
ifeq "$(FT_VER)" "2.3.9"
	ln -sf libfreetype.so.6.3.20    $(DESTDIR)$(libdir)/libfreetype.so
	ln -sf libfreetype.so.6.3.20    $(DESTDIR)$(libdir)/libfreetype.so.6
endif
