...
#ifndef MP_ION_PATCH_CACHE_FLUSH_MOD
...
/**
 * DOC: ION_IOC_CUST_IMPORT -  install fd point to same file of another process's fd
 *
 * Takes an ion_cust_import_data struct and returns newfd for current process
 */
#define ION_IOC_CUST_IMPORT        _IOWR(ION_IOC_MAGIC, 11, \
                      struct ion_cust_import_data)
