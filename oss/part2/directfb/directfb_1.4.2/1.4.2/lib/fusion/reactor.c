                                 ...
                                 const ReactionFunc *globals )
{
     ...
     /* DTV03250334
        original flow first: process_globals, second: _fusion_reactor_process_message
        new flow first: _fusion_reactor_process_message, second: process_globals
        
        _fusion_reactor_process_message post event to master process,
        process_globals post window event with _dfb_windowstack_inputdevice_listener.
        When window do some opeation, it include dfb_windowstack_lock/dfb_windowstack_unlock,
        _dfb_windowstack_inputdevice_listener will wait previous window operation finish.
        To avoid delay _fusion_reactor_process_message post event to master process,
        we change the order of local reactions and global reactions. */
