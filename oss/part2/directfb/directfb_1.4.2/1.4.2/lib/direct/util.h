...
#define DFB_UTOPIA_TRACE(X...)                                                  \
do {                                                                            \
D_INFO("\33[0;33;44m[DFB]utopia API trace===>\33[0m start %s (%s, %s, %d)\n",   \
            #X, __FILE__, __FUNCTION__, __LINE__);                              \
X;                                                                              \
D_INFO("\33[0;33;44m[DFB]utopia API trace===>\33[0m end   %s (%s, %s, %d)\n",   \
            #X, __FILE__, __FUNCTION__, __LINE__);                              \
} while(0)
...
void direct_clock_start( DirectClock *clock );
void direct_clock_stop( DirectClock *clock );
long long direct_clock_diff( DirectClock *clock );
