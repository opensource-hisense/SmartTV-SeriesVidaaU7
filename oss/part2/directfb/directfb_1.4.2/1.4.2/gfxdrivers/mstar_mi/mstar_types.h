...
typedef struct {
     ...
     bool                   a8_palette;
     MI_OSD_RgbColor_t      palette_tbl[MAX_PALETTE_ENTRY_CNT];
     int                    num_entries;

     MI_OSD_RgbColor_t      palette_intensity[MAX_PALETTE_INTENSITY_I4_CNT];
     int                    num_intensity;
...
typedef struct {
     ...
     MI_OSD_Yuv422Format_e     src_ge_yuv_fmt;
     MI_OSD_Yuv422Format_e     dst_ge_yuv_fmt;
     ...
     MI_OSD_DfbBlendMode_e            ge_src_blend;
     MI_OSD_DfbBlendMode_e            ge_dst_blend;
     ...
     MI_OSD_RopMode_e         ge_rop_op;
     MI_HANDLE                hSrcSurface;
     MI_HANDLE                hDstSurface;
