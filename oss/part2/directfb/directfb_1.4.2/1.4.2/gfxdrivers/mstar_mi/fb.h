...
#define FBIOGET_SCREEN_LOCATION _IOR('F', 0x60, MI_FB_Rectangle_t)
#define FBIOSET_SCREEN_LOCATION _IOW('F', 0x61, MI_FB_Rectangle_t)

#define FBIOGET_SHOW _IOR('F', 0x62, bool)
#define FBIOSET_SHOW _IOW('F', 0x63, bool)
