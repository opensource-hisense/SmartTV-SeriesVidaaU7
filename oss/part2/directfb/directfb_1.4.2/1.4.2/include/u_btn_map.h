...
#define BTN_VOICE                   ((unsigned long)(KEY_GROUP_AUD_CTRL | 0x0000f00b))    /**<RC key define        */
...
#if 1//defined( HISENSE_FAC_IR)  //hisense.huxiaopeng.20090807 add
#define BTN_F_NEC_MENU              ((unsigned long)(KEY_GROUP_FCT_CTRL | 0x0000f007))
#define BTN_F_NEC_M                 ((unsigned long)(KEY_GROUP_FCT_CTRL | 0x0000f008))
#endif
#if 1//def HIS_IR_CODE_AU  //zhouxu.Change 0705
#define BTN_MEDIA                   ((unsigned long)(KEY_GROUP_FCT_CTRL | 0x0000f009))
#define BTN_INTERNET                ((unsigned long)(KEY_GROUP_FCT_CTRL | 0x0000f00a))
#endif
...
#define BTN_BL_TIME                 ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f11f))    /**<RC key define        */
...
#define BTN_CUSTOM_203              ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f153))


#if 1//def HISENSE_FAC_IR
#define BTN_F_NEC_HDMI          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f208))  /* ChenChunxiao(2011-03-01)*/  //HIS_NEW_FAC_FOR_USA
#define BTN_F_NEC_VSYS          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f209))
#define BTN_F_NEC_ASYS          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f20a))
#define BTN_F_NEC_PMOD          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f20b))
#define BTN_F_NEC_POWER         ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f20c))
#define BTN_F_NEC_AUTO          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f20d))
#define BTN_F_NEC_SEARCH_DOWN   ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f20e))
#define BTN_F_NEC_SEARCH_UP     ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f20f))
//#define BTN_F_NEC_M      ((UINT32)(KEY_GROUP_USER_DEF | 0x0000f00f))
#define BTN_F_NEC_AFT           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f210))
#define BTN_F_NEC_AGC           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f211))
#define BTN_F_NEC_SUB           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f212))
#define BTN_F_NEC_WB            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f213))
#define BTN_F_NEC_SCAN          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f214))
#define BTN_F_NEC_AGING         ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f215))
#define BTN_F_NEC_BUS           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f216))
#define BTN_F_NEC_AV            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f217))
#define BTN_F_NEC_RDRV_ADD      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f218))
#define BTN_F_NEC_RDRV_SUB      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f219))
#define BTN_F_NEC_RCUT_ADD      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f21a))
#define BTN_F_NEC_RCUT_SUB      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f21b))
#define BTN_F_NEC_GDRV_ADD      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f21c))
#define BTN_F_NEC_GDRV_SUB      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f21d))
#define BTN_F_NEC_GCUT_ADD      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f21f))
#define BTN_F_NEC_GCUT_SUB      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f220))
#define BTN_F_NEC_BDRV_ADD      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f221))
#define BTN_F_NEC_BDRV_SUB      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f222))
#define BTN_F_NEC_BCUT_ADD      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f223))
#define BTN_F_NEC_BCUT_SUB      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f224))
#define BTN_F_NEC_CH_ADD        ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f225))
#define BTN_F_NEC_CH_SUB        ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f226))
#define BTN_F_NEC_VOL_ADD       ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f227))
#define BTN_F_NEC_VOL_SUB       ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f228))
#define BTN_F_NEC_S6            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f22a))
#define BTN_F_NEC_S7            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f22b))
#define BTN_F_NEC_VG2           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f22c))
#define BTN_F_NEC_TILT          ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f22d))
#define BTN_F_NEC_WBH           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f22e))
#define BTN_F_NEC_WBL           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f22f))
#define BTN_F_NEC_DTV           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f230))
#define BTN_F_NEC_S1            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f231))
#define BTN_F_NEC_S2            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f232))
#define BTN_F_NEC_S3            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f233))
#define BTN_F_NEC_VGA           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f234))
#define BTN_F_NEC_OK            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f235))
#define BTN_F_NEC_S4            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f236))
#define BTN_F_NEC_S5            ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f237))
#define BTN_F_NEC_BAL           ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f238))
#endif /* KEY_GROUP_DIGITS */

//hisense.huxiaopeng.20100522.add    //添加新遥控器的几个按键
#if 1//def HIS_IR_CODE_AU
#define BTN_3D                      ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f239))
#define BTN_YAHOO                   ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f240))
#define BTN_PVR                     ((unsigned long)(KEY_GROUP_USER_DEF | 0x0000f241))
#endif
...
#define BTN_NETFLIX                 ((unsigned long)(KEY_GROUP_NETWORK | 0x0000f007))     /*hisense Netflix key, by Jaime*/
...
#define BTN_YOUTUBE                 ((unsigned long)(KEY_GROUP_NETWORK | 0x0000f009))
