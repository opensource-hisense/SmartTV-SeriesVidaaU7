...
PHOTOSPHERE_ROOT="/home/yu.zhang/P4/DAILEO/SN_Branch/SN__-04.13.manhattan/Supernova"
CHIP=manhattan
PROJ_MODE=dvb
export PATH=/tools/arm-2012.09/bin/:$PATH  
#if [ "$1" != "" ]; then
#    CHIP=$1
#fi
...
UTOPIA_LIB_PATH="/home/yu.zhang/MI/MI_project/project/develop/lib/target/arm-gnueabi/4.7/curry/dynamic/hard_float/utopia"
...
if [ "$CHIP" == "t2" ]; then
    ...
    MSTAR_LIB="-lrt -lpthread -ldrvMVOP -lapiGFX -lapiGOP -llinux -ldrvVE -lapiXC -lapiPNL -ldrvWDT -ldrvSAR -ldirect"
fi
#HW_DECODEJPEG_LIBS=" -lapiVDEC -ldrvAUDSP -lapiAUDIO -ldrvIPAUTH -lapiJPEG "
MSTAR_LIB=" -lrt -lpthread -lutopia_glibc"
...
./configure     CC="arm-none-linux-gnueabi-gcc -mlittle-endian" \
                ...
                CFLAGS="$CFLAGS_SETTING $DIRECTFB_CFLAGS_SETTING"  \
                LDFLAGS="-Wl,-rpath,/mslib -Wl,-rpath,/lib $LD_LIB_PATH $DIRECTFB_LIBS_SETTING" \
