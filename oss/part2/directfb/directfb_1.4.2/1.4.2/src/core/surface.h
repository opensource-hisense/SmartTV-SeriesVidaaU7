...
typedef enum {
     ...
     CSTF_AFBC           = 0x00020000, /* surface support AFBC */
...
struct __DFB_CoreSurface
{
     ...
     bool is_api_locked; /* surface is/was locked by Surface->Lock, Surface->Lock2 or Surface->Lock3 */

     bool is_new_allocate_before_locked; /* surface is new allocated before be locked by Surface->Lock, Surface->Lock2 or Surface->Lock3  */

     unsigned int reallocate_count; /* count the number of surface is new allocated */
...
DFBResult dfb_surface_parallel_dump_buffer   ( CoreSurface                  *surface,
                                      CoreSurfaceBufferRole         role,
                                      const char                   *path,
                                      const char                   *prefix,
                                      int                               reset);
