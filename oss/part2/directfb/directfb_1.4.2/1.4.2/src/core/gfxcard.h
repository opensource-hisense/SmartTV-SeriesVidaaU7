...
DFBResult dfb_gfxcard_fillquadrangles        ( DFBPoint             *points,
                                          int                   num,
                                          CardState            *state );

DFBResult dfb_gfxcard_filltrapezoids         ( const DFBTrapezoid   *traps,
                                          int                   num,
                                          CardState            *state );
...
DFBResult dfb_gfxcard_batchblit2             ( DFBRectangle         *rects,
                                          DFBPoint             *points,
                                          DFBPoint             *points2,
                                          int                   num,
                                          CardState            *state );
