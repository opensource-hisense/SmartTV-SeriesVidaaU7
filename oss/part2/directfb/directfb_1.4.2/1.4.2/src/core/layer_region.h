...
DFBResult dfb_layer_region_set_surface_temp ( CoreLayerRegion *region,
...
DFBResult dfb_layer_region_update( CoreLayerRegion *region );

DFBResult dfb_layer_region_ready(CoreLayerRegion *region);
