...
struct __DFB_CoreDFBShared {
     ...
     FusionProperty       lock_sw_sdr2hdr;    /* for parameter of sdr to hdr*/
     bool                 enable_GLES2;       /* run-time enable GLES2 flow*/
     ...
     FusionCall           call;
     FusionReactor   *safe_release_reactor;     /* fusion reactor */

     unsigned int smallMemCount; /* record small memory count */
     unsigned int smallMemTotal; /* record small memory Total */
     unsigned int mediumMemCount; /* record medium memory count */
     unsigned int mediumMemTotal; /* record medium memory Total */
     unsigned int largeMemCount; /* record large memory count */
     unsigned int largeMemTotal; /* record large memory Total */

     int bootlogo_layer_id; /* -1 means no layer for boot logo display, otherwise, it means the index of Layer which is used to display the logo. */
};
