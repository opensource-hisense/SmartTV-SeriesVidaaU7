                        ...
                        DFBWMCoreShared *shared )
{
     ...
     DFB_BOOT_GETTIME( DF_BOOT_WM_CORE_INIT, DF_MEASURE_START, DF_BOOT_LV4);
     DFBResult ret;
     ...
     DFB_BOOT_GETTIME( DF_BOOT_WM_CORE_INIT, DF_MEASURE_END, DF_BOOT_LV4);
     return DFB_OK;
...
dfb_wm_init_stack( CoreWindowStack *stack )
{
     ...
     stack->shared_data = wm_shared->data;
