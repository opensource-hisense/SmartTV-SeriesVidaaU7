...
dfb_state_init( CardState *state, CoreDFB *core )
{
     ...
     state->cmp_mode       = DSBF_ACMP_OP_NONE;
     state->blit_nearestmode_enabled = false;
     state->blit_xmirror_enabled = false;
     state->blit_ymirror_enabled = false;
