...
typedef struct {
     ...
     CoreSurfacePool      *prealloc_invid_pool;
                             ...
                             DFBSurfaceCoreShared *shared )
{
     ...
     DFB_BOOT_GETTIME( DF_BOOT_SURFACE_CORE_INIT, DF_MEASURE_START, DF_BOOT_LV4);
     ...
     DFB_BOOT_GETTIME( DF_BOOT_SURFACE_CORE_INIT, DF_MEASURE_END, DF_BOOT_LV4);
     return DFB_OK;
}
