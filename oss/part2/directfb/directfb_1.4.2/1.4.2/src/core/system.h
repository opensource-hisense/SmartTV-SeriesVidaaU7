...
typedef struct {
	 ...
	 /*
    *  mapping address operations
    */
     bool            (*MPoolMapping)(u8 u8MiuSel, cpu_phy Offset, u32 u32MapSize, bool  bNonCache);
     bool            (*MPoolUnMapping)(void* ptrVirtStart, u32  u32MapSize);
     void*           (*MPoolPA2VANonCached)(cpu_phy pAddrPhys);
} CoreSystemFuncs;
