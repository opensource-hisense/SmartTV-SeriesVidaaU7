...
dfb_layer_core_initialize( CoreDFB            *core,
                           ...
                           DFBLayerCoreShared *shared )
{
     DFB_BOOT_GETTIME( DF_BOOT_LAYER_CORE_INIT, DF_MEASURE_START, DF_BOOT_LV4);
     int                  i;
     DFBResult            ret;
     ...
     DFB_BOOT_GETTIME( DF_BOOT_LAYER_CORE_INIT, DF_MEASURE_END, DF_BOOT_LV4);
