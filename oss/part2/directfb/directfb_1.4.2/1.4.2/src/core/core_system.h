...
static bool
system_MPoolMapping(u8 u8MiuSel, cpu_phy Offset, u32 u32MapSize, bool  
bNonCache);
static bool
...
static CoreSystemFuncs system_funcs = {
     ...
     .MPoolMapping        = system_MPoolMapping,
     .MPoolUnMapping      = system_MPoolUnMapping,
     .MPoolPA2VANonCached = system_MPoolPA2VANonCached,
};
