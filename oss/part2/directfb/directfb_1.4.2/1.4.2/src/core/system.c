...
dfb_system_core_initialize( CoreDFB             *core,
                            ...
                            DFBSystemCoreShared *shared )
{
     DFB_BOOT_GETTIME( DF_BOOT_SYSTEM_CORE_INIT, DF_MEASURE_START, DF_BOOT_LV4);
     DFBResult ret;
     ...
     DFB_BOOT_GETTIME( DF_BOOT_SYSTEM_CORE_INIT, DF_MEASURE_END, DF_BOOT_LV4);
     return DFB_OK;
}
...
{
     D_ASSERT( system_funcs != NULL );
     return system_funcs->VideoRamAvailable(arg);
