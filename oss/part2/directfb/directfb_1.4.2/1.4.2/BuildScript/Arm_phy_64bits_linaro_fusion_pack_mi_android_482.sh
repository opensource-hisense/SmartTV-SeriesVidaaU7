...
./configure     CC="$_CC_" \
                ...
                LDFLAGS="-Wl,-rpath,/vendor/linux_rootfs/lib -Wl,-rpath,/vendor/linux_rootfs/basic/lib -Wl,-rpath,/vendor/tvservice/glibc -Wl,-rpath-link,$UTOPIA_LIB_PATH  $LD_LIB_PATH" \
