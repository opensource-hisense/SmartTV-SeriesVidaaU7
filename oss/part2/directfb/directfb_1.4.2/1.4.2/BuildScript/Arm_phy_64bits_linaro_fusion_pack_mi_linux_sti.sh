...
CPPFLAGS_SETTING+=" -I$DFB_NEEDED_PATH"
...
ln -s -f $KERNELDIR/include/uapi/linux/mtk-v4l2-g2d.h $DEPENDENCY_LIB_ROOT/include/mtk-v4l2-g2d.h
ln -s -f $KERNELDIR/include/uapi/linux/videodev2.h $DEPENDENCY_LIB_ROOT/include/videodev2.h
ln -s -f $KERNELDIR/include/uapi/linux/dma-heap.h $DEPENDENCY_LIB_ROOT/include/dma-heap.h
...
ln -s -f $KERNELDIR/include/uapi/drm/mtk_tv_drm.h $DEPENDENCY_LIB_ROOT/include/mtk_tv_drm.h
fi
