...
$DFB_PATH/configure     CC="$_CC_" \
                ...
                LDFLAGS="-Wformat=2 -Wformat-security -fstack-protector-strong -D_FORTIFY_SOURCE=2 -O2 -Wl,-z,noexecstack -Wl,-z,noexecheap -Wl,-z,relro -Wl,-z,now -s -Wl,-rpath-link,$UTOPIA_LIB_PATH  $LD_LIB_PATH" \
