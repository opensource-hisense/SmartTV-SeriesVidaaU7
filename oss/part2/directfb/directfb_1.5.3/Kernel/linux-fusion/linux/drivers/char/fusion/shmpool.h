...
#if defined(FUSION_SHM_BASE_FOR_ADDRESS_SANITIZER)
#define FUSION_SHM_BASE_64	(FUSION_SHM_BASE_FOR_ADDRESS_SANITIZER)	/* ASAN use 0x20000000~0x3fffffff, fusion move to another place */
#else
#define FUSION_SHM_BASE_64	0x20000000	/* virtual base address */
#endif
#define FUSION_SHM_SIZE_64	0x20000000	/* size of virtual address space */
