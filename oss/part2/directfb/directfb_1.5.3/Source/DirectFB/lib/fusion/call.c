                     ...
                     int                 *ret_val)
{
     ...
     if (flags & FCEF_ONEWAY) {
          ...
          snprintf( addr.sun_path, sizeof(addr.sun_path), 
                    LINUX_TMP_PATH"/.fusion-%d/%lx", call->shared->world_index, call->fusion_id );
          ...
          len = snprintf( addr.sun_path, sizeof(addr.sun_path), 
                          LINUX_TMP_PATH"/.fusion-%d/call.%x.", fusion_world_index( world ), call->call_id ); 
                    ...
                    int           val )
{
     ...
     addr.sun_family = AF_UNIX;
     snprintf( addr.sun_path, sizeof(addr.sun_path), 
               LINUX_TMP_PATH"/.fusion-%d/call.%x.%x", call->shared->world_index, call->call_id, serial );
     ...
     switch (result) {
          case FCHR_RETURN:
               if (!(msg->flags & FCEF_ONEWAY)) {
                    ...
                    addr.sun_family = AF_UNIX;
                    snprintf( addr.sun_path, sizeof(addr.sun_path), 
                              LINUX_TMP_PATH"/.fusion-%d/call.%x.%x", fusion_world_index( world ), call_id, msg->serial );
