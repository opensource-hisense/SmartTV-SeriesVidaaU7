                                       ...
                                       Chunk                 **ret_chunk )
{
     ...
     direct_log_printf(NULL,"%s[pid=%d][0x%x,0x%x,0x%x,0x%x] \n",__FUNCTION__,getpid(),(int)allocation,manager->avail, manager->length,length);
     ...
     direct_log_printf(NULL,"%s fail[pid=%d][0x%x,0x%x,0x%x] \n",__FUNCTION__,getpid(),manager->avail, manager->length,length);
