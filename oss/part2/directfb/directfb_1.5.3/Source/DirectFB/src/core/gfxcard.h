...
typedef struct _GraphicsDeviceFuncs {
      ...
      */
     void (*FlushTextureCache)( void *driver_data, void *device_data, CoreSurfaceBufferLock *lock );

     /*
      * After the video memory has been written to by the accelerator
      * make sure the CPU won't read back cached data.
      */
     void (*FlushReadCache)( void *driver_data, void *device_data, CoreSurfaceBufferLock *lock );
     ...
     void (*FinishGLES2)( void *driver_data, void *device_data );
} GraphicsDeviceFuncs;
