...
************************************************************************************************/
...

   {
	   ...
	   {
           D_DEBUG_AT(Core_InputEvt, "  -> Discard state, wouldn't dispatch key to top level\n");
		   return;
	   }
   }
#endif	
...
************************************************************************************************/
     ...
     if (core_input_filter( device, event ))
          D_DEBUG_AT( Core_InputEvt, " %s,%d ****>> FILTERED\n", __func__, __LINE__ );
     else
