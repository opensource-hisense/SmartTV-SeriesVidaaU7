...
typedef enum {
     ...
     CSAID_GFX           = CSAID_GPU,   /* primary acclerator for 2D GFX */

     CSAID_OSD           = 0x00000003,  /* primary display acclerator */

     CSAID_IMGRZ         = 0x00000004,  /* primary acclerator for IMGRZ */

     CSAID_DMA           = 0x00000005,  /* dma_buf accelerator */

     CSAID_ACCEL_MAX     = 0x00000006,  /* max hw/sw acclerator */
